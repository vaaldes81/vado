QBCore = exports['nchub']:GetCoreObject()
...
local function OpenMenu()
    local OpenMenu = {
        ...
        
        {
            ...
            txt = "",
            params = {
                event = "tds-menu:client:closeMenu",
            }
        },
        
    }

    exports['tds-menu']:openMenu(OpenMenu)
end
...
local function PartsMenu()
    ...
    if VehicleStatus[plate] ~= nil then
        ...
        exports['tds-menu']:openMenu(vehicleMenu)
    end
...
local function PartMenu(data)
    ...
    exports['tds-menu']:openMenu(TestMenu1)
end
...
local function NoDamage()
    ...
    exports['tds-menu']:openMenu(NoDamage)
end
...
local function SpawnListVehicle(model)
    ...
    QBCore.Functions.SpawnVehicle(model, function(veh)
        ...
        exports['tds-fuel']:SetFuel(veh, 100.0)
